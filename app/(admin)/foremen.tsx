...
function useColors() {
  ...
  return {
    ...
    searchBorderActive: isDark ? "#22c55e" : "#007AFF",
    ...
    infoBg: isDark ? "rgba(34, 197, 94, 0.1)" : "#f0fdf4",
    infoBorder: isDark ? "rgba(34, 197, 94, 0.3)" : "#bbf7d0",
    infoText: isDark ? "#22c55e" : "#15803d",
