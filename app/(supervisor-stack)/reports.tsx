...
const themes = {
  dark: {
    ...
    textTertiary: "#cbd5e1",
    accent: "#22c55e",
    accentOverlay: "rgba(34,197,94,0.9)",
    accentLight: "rgba(34,197,94,0.18)",
    accentBorder: "rgba(34,197,94,0.45)",
    accentSelected: "rgba(34,197,94,0.12)",
    success: "#16a34a",
    error: "#dc2626",
    modalOverlay: "rgba(0,0,0,0.6)",
    buttonBg: "rgba(148,163,184,0.2)",
    accentDisabled: "rgba(34,197,94,0.35)",
    sheetBg: "#0f172a",
